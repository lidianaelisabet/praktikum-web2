          ...
          <section class="content">
            <main>
              <div class="container-fluid px-4">
                <h1 class="mt-4 text-black">List Kategori</h1>
                <a class="btn btn-warning" href="create_kategori.php" role="button">Create Kategori</a><br><br>
                    ...
                    foreach ($rs as $row) { ?>
                      ...
                      <tr>
                        ...
                        <td class=>
                          ...
                          <a class="btn btn-danger" href="delete_kategori.php?iddel=<?= $row['id'] ?>" onclick="if(!confirm('Anda Yakin Hapus Data Produk <?= $row['kategori_produk'] ?>?')) {return false}">Delete</a>
                        </td>
                      </tr>
                    <?php
                      $nomor++;
