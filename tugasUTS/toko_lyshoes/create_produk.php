    ...
    <section class="content">
      ...
      <div id="layoutSidenav_content">
                ...
                <form method="POST" action="proses_produk.php">
                    ...
                    <div class="form-group row">
                        <label for="gambar" class="col-4 col-form-label">Link Foto</label> 
                        <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <div class="input-group-text">
                            ...
                            <input id="gambar" name="gambar" value="" type="text" class="form-control" placeholder="Masukkan Link Foto">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="katrgori_prduk_id" class="col-4 col-form-label">Kategori Produk</label> 
                        <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <div class="input-group-text">
