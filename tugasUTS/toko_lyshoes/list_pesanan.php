      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="list_pesanan.php" class="nav-link active">
                  ...
                  <tbody>
                    ...
                    foreach ($rs as $row) { ?>
                      ...
                      <tr>
                        ...
                        <td class=>
                          <a class="btn btn-danger" href="delete_pesanan.php?iddel=<?= $row['id'] ?>" onclick="if(!confirm('Anda Yakin Hapus Data Produk <?= $row['nama_pemesan'] ?>?')) {return false}">Delete</a>
                        </td>
                      </tr>
                    <?php
                      $nomor++;
